      ...
      try {
        ...
        if (paymentData.status === "COMPLETE") {
          if (token) {
            ...
            await axios.post(`${APP_URL}/generate-signature`, order, config);
          }
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 px-4 overflow-hidden relative">
      ...
      >
        ...
        <div
          className="absolute -bottom-4 -left-4 w-6 h-6 bg-emerald-400 rounded-full orbiting-icon opacity-60"
        ...
        >
          ...
          <div className="relative mx-auto w-28 h-28 mb-8 floating-4d">
            ...
            <div
              className="absolute bottom-0 left-1/2 w-4 h-4 bg-emerald-400 rounded-full orbiting-icon opacity-70"
          ...
          <div className="mb-6" style={{ transformStyle: "preserve-3d" }}>
            ...
            <div
              className="w-24 h-1 bg-gradient-to-r from-green-400 to-emerald-500 mx-auto rounded-full mb-6 floating-4d"
          ...
          <div
            className="text-xs text-gray-400 floating-4d"
